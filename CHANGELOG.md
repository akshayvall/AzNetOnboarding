...
- Rebuilt the mobile curriculum drawer with readable 48px module rows, a visible close control, wider title space, and no duplicate row padding or time-label crowding.
